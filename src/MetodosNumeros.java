...
public class MetodosNumeros {
    ...
    public static ArrayList<Integer> metodoMultiplicador(ArrayList<Integer> numeros, int factor) {
    ...
    public static HashSet<Integer> metodoCuadradosUnicos(ArrayList<Integer> numeros){
